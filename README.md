...
- 会话置顶、归档、复制为分支、跨分区移动
- 根据会话运行状态显示不同颜色提示：运行中为绿色、等待交互为红色、已完成为橙色；当前查看的已完成会话显示为灰色
- 折叠侧边栏时显示工作 / 生活快捷按钮
...
重启后，侧边栏中会出现「工作 / 生活」切换按钮。项目会按 DSH 工作区分组，会话数据由 DSH 提供，分区、置顶、归档偏好和已完成状态保存在浏览器本地。运行中为绿色、等待交互为红色、已完成为橙色；当前查看的已完成会话显示为灰色。
